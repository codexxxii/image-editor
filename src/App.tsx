...
import { Image, Crop, Sun, Sparkles, ImagePlus } from "lucide-react";
        ...
        <MaxWidthWrapper className="flex h-[calc(100vh-80px)] items-center justify-between gap-20">
          ...
          >
            ...
            <div className="mt-10 flex gap-4">
              <UploadButton>
                <button className="bg-black font-semibold text-white transition hover:scale-105">
                  Start Editing
                </button>
              </UploadButton>

              <button className="border backdrop-blur transition hover:bg-white/10">
                Learn More
              </button>
            </div>
